...
characters = {'volt': [0,0,255], #blue
             ...
             'penny': [255,0,127], #pink
             'mommy': [255,0,255], #purple
             'daddy': [131,137,150], #roman silver
             'athena': [0,255,0], #green
            }
...
#Display colors on blinkt, providing variet of options
def display_color(name):
    #Rainbow if name is rainbow
    if name in ['rainbow']:
        rainbow()
    elif name in ['quit']:
    #quit option
    ...
    #Allow color display via direct list input ie: 255,0,255
